      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="animate-on-scroll grid lg:grid-cols-2 gap-12 items-center mb-16">
          ...
          <div className="hidden lg:block">
            <img
              src="https://images.pexels.com/photos/4266944/pexels-photo-4266944.jpeg?auto=compress&cs=tinysrgb&w=600&h=400&fit=crop"
              alt="Woman consulting with her doctor in clinic"
